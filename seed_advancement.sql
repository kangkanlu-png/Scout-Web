...
INSERT OR IGNORE INTO advancement_requirements
  (id, section, rank_from, rank_to, requirement_type, title, description, required_count, unit, is_mandatory, display_order)
VALUES
  ('adv-senior-01-01','行義童軍','見習童軍','初級童軍','attendance','完成例會出席','出席至少12次例會',12,'次',1,1),
  ('adv-senior-01-02','行義童軍','見習童軍','初級童軍','test','完成初級考核','通過初級行義知識考核',1,'次',1,2),
  ('adv-senior-01-03','行義童軍','見習童軍','初級童軍','service','完成服務時數','累積至少6小時社區服務',6,'小時',1,3),
  ('adv-senior-01-04','行義童軍','見習童軍','初級童軍','camp','完成露營活動','參加至少1次露營活動',1,'次',0,4);

-- 2. 初級行義 → 中級行義
INSERT OR IGNORE INTO advancement_requirements
  (id, section, rank_from, rank_to, requirement_type, title, description, required_count, unit, is_mandatory, display_order)
VALUES
  ('adv-senior-02-01','行義童軍','初級童軍','中級童軍','attendance','完成例會出席','出席至少16次例會',16,'次',1,1),
  ('adv-senior-02-02','行義童軍','初級童軍','中級童軍','test','完成中級考核','通過中級行義知識考核',1,'次',1,2),
  ('adv-senior-02-03','行義童軍','初級童軍','中級童軍','service','完成服務時數','累積至少12小時社區服務',12,'小時',1,3),
  ('adv-senior-02-04','行義童軍','初級童軍','中級童軍','badge','取得技能章','取得至少3枚技能章',3,'枚',1,4),
  ('adv-senior-02-05','行義童軍','初級童軍','中級童軍','camp','完成露營活動','參加至少2次露營活動',2,'次',0,5);

-- 3. 中級行義 → 高級行義
INSERT OR IGNORE INTO advancement_requirements
  (id, section, rank_from, rank_to, requirement_type, title, description, required_count, unit, is_mandatory, display_order)
VALUES
  ('adv-senior-03-01','行義童軍','中級童軍','高級童軍','attendance','完成例會出席','出席至少20次例會',20,'次',1,1),
  ('adv-senior-03-02','行義童軍','中級童軍','高級童軍','test','完成高級考核','通過高級行義知識考核',1,'次',1,2),
  ('adv-senior-03-03','行義童軍','中級童軍','高級童軍','service','完成服務計畫','規劃執行1次服務活動',1,'次',1,3),
  ('adv-senior-03-04','行義童軍','中級童軍','高級童軍','badge','取得技能章','取得至少5枚技能章',5,'枚',1,4),
  ('adv-senior-03-05','行義童軍','中級童軍','高級童軍','camp','完成野外活動','完成至少1次野外技能活動',1,'次',1,5);

-- 4. 高級行義 → 獅級行義
INSERT OR IGNORE INTO advancement_requirements
  (id, section, rank_from, rank_to, requirement_type, title, description, required_count, unit, is_mandatory, display_order)
VALUES
  ('adv-senior-04-01','行義童軍','高級童軍','獅級童軍','attendance','完成例會出席','出席至少24次例會',24,'次',1,1),
  ('adv-senior-04-02','行義童軍','高級童軍','獅級童軍','test','完成獅級考核','通過獅級行義知識考核',1,'次',1,2),
  ('adv-senior-04-03','行義童軍','高級童軍','獅級童軍','service','完成大型服務','帶領完成1次大型社區服務',1,'次',1,3),
  ('adv-senior-04-04','行義童軍','高級童軍','獅級童軍','badge','取得技能章','取得至少7枚技能章',7,'枚',1,4),
  ('adv-senior-04-05','行義童軍','高級童軍','獅級童軍','other','擔任領袖','擔任隊伍領袖職務一學期',1,'學期',0,5);

-- 5. 獅級行義 → 長城行義
INSERT OR IGNORE INTO advancement_requirements
  (id, section, rank_from, rank_to, requirement_type, title, description, required_count, unit, is_mandatory, display_order)
VALUES
  ('adv-senior-05-01','行義童軍','獅級童軍','長城童軍','attendance','完成例會出席','出席至少28次例會',28,'次',1,1),
  ('adv-senior-05-02','行義童軍','獅級童軍','長城童軍','test','完成長城考核','通過長城行義知識考核',1,'次',1,2),
  ('adv-senior-05-03','行義童軍','獅級童軍','長城童軍','service','完成持續服務','持續參與社區服務計畫',24,'小時',1,3),
  ('adv-senior-05-04','行義童軍','獅級童軍','長城童軍','badge','取得技能章','取得至少9枚技能章',9,'枚',1,4),
  ('adv-senior-05-05','行義童軍','獅級童軍','長城童軍','other','擔任副隊長','擔任副隊長職務',1,'學期',0,5);

-- 6. 長城行義 → 國花行義
INSERT OR IGNORE INTO advancement_requirements
  (id, section, rank_from, rank_to, requirement_type, title, description, required_count, unit, is_mandatory, display_order)
VALUES
  ('adv-senior-06-01','行義童軍','長城童軍','國花童軍','attendance','完成例會出席','出席至少32次例會',32,'次',1,1),
  ('adv-senior-06-02','行義童軍','長城童軍','國花童軍','test','完成國花考核','通過國花行義知識考核',1,'次',1,2),
  ('adv-senior-06-03','行義童軍','長城童軍','國花童軍','service','完成公益計畫','完成1次大型公益服務計畫',1,'次',1,3),
  ('adv-senior-06-04','行義童軍','長城童軍','國花童軍','badge','取得技能章','取得至少11枚技能章',11,'枚',1,4),
  ('adv-senior-06-05','行義童軍','長城童軍','國花童軍','other','擔任隊長','擔任隊長職務一學期',1,'學期',1,5);
