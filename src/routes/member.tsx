  ...
  <div class="max-w-5xl mx-auto px-4">
    <div class="flex items-center justify-between h-14">
      ...
      <div class="flex items-center gap-2">
        ...
        <button onclick="document.getElementById('pwd-modal').classList.remove('hidden')" class="bg-blue-700 hover:bg-blue-600 text-white text-xs px-3 py-1.5 rounded-full transition-colors">
